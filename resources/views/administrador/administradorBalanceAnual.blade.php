...
<div class="col-lg-12 ">
    <div class="card center-block">
        <div class="card-header">
            <strong class="card-title">Estado Financiero Anual</strong>
        </div>
        <div class="card-body card-block">
            <form action="{{route('excel')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                {{ csrf_field() }}
