        ...
        <nav class="navbar navbar-expand-sm navbar-default ">
            <div id="main-menu" class="main-menu collapse navbar-collapse ">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="{{route('superAdministradorBalanceAnual')}}" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false"><i class="menu-icon fa fa-calendar"></i>Anual</a></li>


                    <!-- Menu Resumen -->
                    <li class="menu-title">Resumen</li>
                    <li>
                        <a href="{{route('superAdministradorResumenBalanceAnual')}}" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-file-text-o"></i>Anual</a>
                    </li>


                    <li class="menu-title">Indicadores</li>
                    <li>
                        <a href="{{route('superAdministradorIndicadoresAnual')}}" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-bar-chart-o"></i>Anual</a>
                    </li>
                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <h1>Administrador: {{$User->first()->nombre}}</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
