            ...
            <div class="header-menu ">
                ...
                <div class="user-area dropdown float-right">
                    ...
                    <div class="user-menu dropdown-menu" style="color:black;">
                        ...
                        <a class="nav-link" href=""><i class="fa fa- user"></i>Mi Información</a>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <h4><a href="{{ route('superAdministradoresPrincipal') }}">Panel Administración</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <h4><a href="suadministrador/{{$users->id}}">{{$users['nombre']}}</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
